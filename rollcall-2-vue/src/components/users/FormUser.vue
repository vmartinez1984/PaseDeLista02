                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" :class="{ 'is-invalid': errors.email.hasError }"
                                placeholder="Correo" v-model="user.email" :disabled="disabled"
                                @keyup="errors.email.hasError = false">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" placeholder="Contraseña" v-model="user.password"
                                :disabled="disabled" :class="{ 'is-invalid': errors.lastName.hasError }"
                                @keyup="errors.lastName.hasError = false">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" :class="{ 'is-invalid': errors.roleId.hasError }"
                                v-model="user.roleId" :disabled="disabled" @keyup="errors.roleId.hasError = false">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" :class="{ 'is-invalid': errors.name.hasError }" id="name"
                                placeholder="Nombre" v-model="user.name" :disabled="disabled"
                                @keyup="errors.lastName.hasError = false">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Apellidos" v-model="user.lastName"
                                :disabled="disabled" :class="{ 'is-invalid': errors.lastName.hasError }"
                                @keyup="errors.lastName.hasError = false">
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" v-model="user.birthday" :disabled="disabled"
                                :class="{ 'is-invalid': errors.birthday.hasError }" @keyup="errors.birthday.hasError = false">
                            <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" v-model="user.genere" :disabled="disabled"
                                :class="{ 'is-invalid': errors.genere.hasError }" @keyup="errors.genere.hasError = false">
            ...
            <div class="card-footer">
                <div class="text-end">
                    <template v-if="isDelete">
                        ...
                        <router-link to="/users" class="btn btn-secondary mx-1"
                            :class="{ 'disabledlink': isDeleting }">Cancelar</router-link>
                    </template>
                    <template v-else>
                        ...
                        <router-link to="/users" class="btn btn-secondary mx-1"
                            :class="{ 'disabledlink': disabled }">Cancelar</router-link>
                    </template>
                </div>
            </div>
        </div>
